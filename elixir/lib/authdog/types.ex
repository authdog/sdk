defmodule Authdog.Types do
  ...
  defmodule Names do
    ...
    defstruct [:id, :formatted, :family_name, :given_name, :middle_name, :honorific_prefix, :honorific_suffix]
  ...
  defmodule User do
    ...
    defstruct [
      :id, :external_id, :user_name, :display_name, :nick_name, :profile_url,
      :title, :user_type, :preferred_language, :locale, :timezone, :active,
      :names, :photos, :phone_numbers, :addresses, :emails, :verifications,
      :provider, :created_at, :updated_at, :environment_id
    ]
